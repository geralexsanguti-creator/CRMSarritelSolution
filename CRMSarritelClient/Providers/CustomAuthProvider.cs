using CRMSarritelClient.Helpers;
...
namespace CRMSarritelClient.Providers
{
    public class CustomAuthProvider(IJSRuntime js, HttpClient httpClient) : AuthenticationStateProvider, IAuthService
    {
